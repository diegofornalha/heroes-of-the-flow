...
namespace GraphQL4Unity
{
    public class GraphQLWebsocketWebGL : GraphQLWebsocket
    {
        ...
        protected override IWebSocket GetWebsocket() // is getting overwritten in GraphQLWebsocketWebGL!
        {
            return new WebsocketJS();
        }
#endif
    }
    ...
    public class WebsocketJS : IWebSocket
    {
        ...
        public event WebSocketMessage MessageWrite;
